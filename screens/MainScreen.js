import { View, Text, KeyboardAvoidingView, TouchableWithoutFeedback, TextInput, SafeAreaView, Keyboard, StyleSheet, Pressable, ScrollView, Image, ActivityIndicator } from 'react-native';
import React, { useEffect, useState } from 'react';
import { TouchableOpacity } from 'react-native-gesture-handler';
import { AlignLeft, Search, Volume2, VolumeOff, X } from 'lucide-react-native';
...
{/* <Button title="Press me" onPress={() => { throw new Error('Hello, again, Sentry!'); }}/> */}
                    ...
                    <View className="mt-12">
                        ...
                        <View className={`w-full mt-12 relative z-20  bg-gray-200  ${!inputText && 'rounded-xl'}`}>
                            <Animated.View
                                style={{
                                    top: labelTop,
                                    left: labelLeft,
                            ...
                            <TextInput
                                ...
                                onBlur={() => { if (!inputText) setInputLabel(false); }}
                        ...
                        <Animated.View style={{
                            ...
                            >
                               {
                                latestWord ? (
                                    <>
                                         <View>
                                  <Text className="text-white font-thin">Last saved word</Text>
                                  <View className="flex-row  items-center ">
                                    <Text className="text-white font-semibold text-2xl">{latestWord.id}</Text>
                                    {
                          ...
                          style={{ width: '100%', height: 150, borderRadius: 8, marginTop: 10 }} // Adjust height as needed
