...
const LoginWelcomeScreen = ({navigation}) => {
    ...
    const description = "Welcome to LexSee, where you can explore AI-driven definitions and visualize words with captivating images to enhance your English learning experience!";
