      ...
      <GestureHandlerRootView style={styles.container}>
        ...
        <View className=" mb-10">
          <View className="flex-row justify-between ">
            ...
            >
              <Text className="font-semibold" style={[styles.tabText, activeTab === 0 && styles.activeTabText]}>Definition</Text>
            </TouchableOpacity>
            <TouchableOpacity
                 className=' flex justify-center items-center'
            ...
            >
              <Text className="font-semibold"  style={[styles.tabText, activeTab === 1 && styles.activeTabText]}>Image</Text>
            </TouchableOpacity>
          </View>
          {/* Animated sliding bar */}
          <Animated.View className="flex  justify-center items-center" style={[styles.slidingBar, barStyle]} >
                <View style={{height:4}} className="bg-black w-24 rounded-full  mt-4"></View>
          </Animated.View>
        </View>
